...
class LicenseActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loadLicenseInfo(layout, "Bus Arrival API", "BusApi", null, "사로로", true)
        loadLicenseInfo(layout, "Jsoup", "Jsoup", "MIT License", "Jonathan Hedley", false)
        loadLicenseInfo(layout, "Material Design", "MaterialDesign", "Apache License 2.0", "Google", false)
    ...
    private fun loadLicenseInfo(layout: LinearLayout, name: String, fileName: String, license: String?, dev: String, tf: Boolean) {
        ...
        if (tf)
            title.text = Html.fromHtml("<b>$name<b>")
        else
            title.text = Html.fromHtml("<br><b>$name<b>")
        title.textSize = 24f
        ...
        txt.setBackgroundColor(Color.parseColor("#E1F5FE"))
        layout.addView(txt)
    }
